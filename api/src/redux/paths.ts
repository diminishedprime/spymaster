...
export const gameByGameIdPath = (gameId: t.GameId) => R.lensPath(gameByGameIdA(gameId))
export const userByUserIdPath = (userId: t.UserId) => R.lensPath(userByUserIdA(userId))
export const wsByUserIdPath = (userId: t.UserId) => R.lensPath(wsByUserIdA(userId))
export const cardsPath = R.lensPath(cardsA)
export const cardTeamByCardId = (cardId: t.CardId) => R.lensPath(cardTeamByCardIdA(cardId))
